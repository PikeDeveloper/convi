...
class DropDownInpuITriangle3 extends StatelessWidget {
  DropDownInpuITriangle3({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ContainerTriangleInputs(
      DropdownButton(
        ...
        value: trigonometryProvider.input_3,
        items: getOpcionesDropdownInputUnits(context, _unitList),
        onChanged: (opt) {
          trigonometryProvider.input_3 = opt;
        },
      ),
    );
  }
